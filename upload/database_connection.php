...
$create_items_table = "CREATE TABLE IF NOT EXISTS items(ID int  NOT NULL auto_increment, I_NAME VARCHAR(60)  NOT NULL, I_DESC VARCHAR(200)  NOT NULL, I_PRICE VARCHAR(40) NOT NULL, I_PATH VARCHAR(200) NOT NULL, I_CODE VARCHAR(40) NOT NULL,   PRIMARY KEY(ID))";
